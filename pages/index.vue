            ...
            <v-col xl="9" lg="8" cols="12" class="pa-0">
                <v-row class="ma-0 pa-0">
                    <v-card elevation="0" tile class="pa-0 ma-0 mt-3">
                        ...
                        <v-card-actions
                            class="overflow-y-auto films-card align-start mt-5"
                        >
                            <filmCard
                                v-for="film in filmsInCinema"
                                :key="film.id"
                                class="ml-5 film-first-child"
                                :name="film.name"
                                :src="film.src"
                                :ENname="film.ENname"
                            />
                ...
                <v-row class="d-flex justify-center ma-0 pa-0 my-2">
                    <collectionCard
                        :class="{
                            ...
                            'collection-card-mob': $vuetify.breakpoint.xs,
                        }"
            ...
            <v-col xl="3" lg="4" cols="0" class="pa-0">
                <v-row class="ma-0 pa-0">
                    <v-card
                        width="340"
                        elevation="0"
                        class="ma-auto d-none d-lg-block"
                    >
                        <v-card-title>Вы хотели посмотреть</v-card-title>
                        <v-card-actions>
                            <v-slide-group show-arrows>
                                <v-slide-item
                                    v-for="film in wantToWatchList"
                                    :key="film.id"
                                >
                                    <filmCard
                                        class="mx-15"
                ...
                <v-row class="ma-0 pa-0">
                    <v-card elevation="3" class="pa-2 ml-10 d-none d-lg-block">
                        <v-card-title class="title"
                            >Фильмы в тренде</v-card-title
                        >
                        <div
                            v-for="trend in filmsInTrends"
                            :key="trend.id"
                            class="d-flex align-center mb-2"
                            style="cursor: pointer"
                        >
                            <div style="font-size: 30px" class="mr-2">
                                {{ trend.id }}.
                            </div>
                ...
                <v-row class="ma-0 pa-0 mt-5">
                    <v-card elevation="3" class="pa-2 ml-10 d-none d-lg-block">
                        <v-card-title class="title"
                            >Популярные сериалы</v-card-title
                        >
                        <div
                            v-for="trend in serialsInTrends"
                            :key="trend.id"
                            class="d-flex align-center mb-2"
                            style="cursor: pointer"
                        >
