    ...
    <div>
        ...
        >
            <v-list class="pa-0">
                ...
                <v-list-group active-class="white--text" no-action value="true">
                    ...
                    <v-list-item @click="$router.push('/online')">
                        ...
                        <v-list-item-title>Онлайн</v-list-item-title>
                    </v-list-item>
                    <v-list-item @click>
                        <v-list-item-icon class="mr-1">
        ...
        >
            <v-row class="mx-xs-n4 mx-md-auto">
                ...
                <v-col class="ma-auto" cols="5" md="2" xl="1">
                    <v-toolbar-title
                        class="white--text title-name"
                        @click="$router.push('/')"
                        style="cursor: pointer"
                        >MuloPoisk</v-toolbar-title
                    >
                </v-col>
                <v-row class="d-none d-md-flex" md="8" xl="9">
                    ...
                    >
                        <template v-slot:activator="{ on }">
                            <v-btn
                                v-on="on"
                                class="mt-auto mb-auto btn-class"
                                color="primary"
                                tile
                                height="48px"
                                elevation="0"
                            >
                                <v-list-item-icon class="mr-1 ma-auto">
                                    <v-icon>theaters</v-icon> </v-list-item-icon
                                >Фильмы
                            </v-btn>
                        </template>
                        <v-list
                    ...
                    >
                        <template v-slot:activator="{ on }">
                            ...
                            >
                                <v-list-item-icon class="mr-1 ma-auto">
                                    <v-icon>tv</v-icon> </v-list-item-icon
                                >Сериалы
                            </v-btn>
                        </template>
                        <v-list
                ...
                <v-col cols="6" class="ma-auto" md="2" xl="2">
                    <v-text-field
                        label="Поиск"
                        single-line
                        outlined
